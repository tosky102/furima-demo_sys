...
class CartController extends FrontAppController {
    ...
    function clearance_complete() {
        ...
        if (empty($this->Cart->getCustomer())) {
            $this->redirect('/cart/clearance');
        }
