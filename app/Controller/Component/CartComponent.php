...
//        $this->loadHelper('UploadPack.Upload');
//    }
...
//        $imgurl = $this->Upload->uploadUrl($array['Item'],'Item.main_image',array('style'=>'list_s'));
//        $img_path = str_replace('//','/',WWW_ROOT.$imgurl);
//        if(!file_exists($img_path) || !$img_path || substr_count($imgurl, '.') > 1){
//            $imgurl = "/img/front_s.png";
//        }
